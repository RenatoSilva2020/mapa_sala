  ...
  return (
    <div className="flex flex-col items-center print:m-0 print:p-0">
      <div 
        ...
        } print:border-black print:bg-white print:w-28 print:h-18`}
      >
        {student ? (
      ...
      {/* Chair drawing */}
      <div className={`w-16 h-3 border-b-2 border-l-2 border-r-2 border-slate-400 mt-1 print:border-black print:w-18 print:h-2 transition-colors ${isSelected ? 'border-blue-500' : ''}`}></div>
    </div>
  );
}
