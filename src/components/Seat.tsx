...
export function Seat({ id, student, onDeleteStudent, onUnseatStudent, isSelected, onSelect, onSelectStudent, isLocked }: SeatProps) {
  ...
  return (
    <div className="flex flex-col items-center print:m-0 print:p-0">
      ...
      {/* Chair drawing */}
      <div className={`w-16 h-3 border-b-2 border-l-2 border-r-2 border-slate-400 mt-1 print:border-black print:w-18 print:h-3 transition-colors ${isSelected ? 'border-blue-500' : ''}`}></div>
    </div>
  );
}
